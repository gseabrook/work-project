 ...
 * It is handled in the ACMessageController
 *
 * @see ACMessageController ACMessageController
 */
public class FpxACMessageDTO {
    ...
    public String getFpx_makeName() {
        return fpx_makeName;
    }

    public void setFpx_makeName(String fpx_makeName) {
        this.fpx_makeName = fpx_makeName;
    }
